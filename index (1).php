...
<head>
    ...
    *::after {
    ...
    .h-visual {
        position: absolute;
        inset: 0;
        background: url('https://images.unsplash.com/photo-1586528116311-ad8ed7c663be?auto=format&fit=crop&w=1920&q=80') center/cover;
    ...
    .mask-full-img {
        position: absolute;
        inset: 0;
        background: url('https://images.unsplash.com/photo-1590247813693-5541d1c609fd?auto=format&fit=crop&w=2400&q=80') center/cover;
        filter: brightness(.4);
    ...
    .trk-terminal {
        max-width: 800px;
        margin: 80px auto 0;
        background: linear-gradient(135deg, rgba(15, 15, 15, 1), rgba(10, 10, 10, 1));
        border: 1px solid var(--bdr);
        border-radius: 40px;
        padding: 80px 60px;
        position: relative;
    ...
    .trk-input:focus {
        outline: none;
        border-color: var(--blue);
        box-shadow: 0 0 30px var(--blue-g)
    }
    ...
    <div id="mainContent">
        ...
        <section class="sec" id="services">
            <div class="container-fluid">
                ...
                <div class="svc-grid">
                    <div class="svc-c reveal-box">
                        <div class="svc-i"><i class="bi bi-cpu"></i></div>
                        <h4>Neural Routing</h4>
                        <p>Machine learning pathways that evolve with every successful delivery across the globe.</p>
                    </div>
                    <div class="svc-c reveal-box">
                        <div class="svc-i"><i class="bi bi-shield-lock"></i></div>
                        <h4>Encrypted Chain</h4>
                        <p>End-to-end cryptographic security for every shipment ledger and client transaction.</p>
                    </div>
                    <div class="svc-c reveal-box">
                        <div class="svc-i"><i class="bi bi-kanban"></i></div>
                        <h4>Fleet Control</h4>
                        <p>Unified command center for managing thousands of autonomous and human nodes.</p>
                    </div>
                    <div class="svc-c reveal-box">
                        <div class="svc-i"><i class="bi bi-lightning"></i></div>
                        <h4>Zero-Delay Express</h4>
                        <p>Priority lane processing for urgent medical, legal, and enterprise-critical assets.</p>
                    </div>
                    <div class="svc-c reveal-box">
                        <div class="svc-i"><i class="bi bi-box-fill"></i></div>
                        <h4>Adaptive Storage</h4>
                        <p>Self-optimizing warehouse modules that reconfigure based on real-time demand flux.</p>
                    </div>
                    <div class="svc-c reveal-box">
                        <div class="svc-i"><i class="bi bi-graph-up"></i></div>
                        <h4>Hyper Analytics</h4>
                        <p>Predictive KPI modeling for logistics companies targeting 100% efficiency.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="sec bg2" id="process">
            <div class="container-fluid">
                ...
                <div class="proc-wrap" id="procWrap">
                    ...
                    <div class="proc-item reveal-box">
                        <div class="p-node">01</div>
                        <h4>Node Integration</h4>
                        <p>Shipment enters the digital mesh. Immediate path calculation triggered across all global
                            nodes.</p>
                    </div>
                    <div class="proc-item reveal-box">
                        <div class="p-node">02</div>
                        <h4>Dynamic Pickup</h4>
                        <p>Proximity-based node assignment ensures pickup within minutes, not hours.</p>
                    </div>
                    <div class="proc-item reveal-box">
                        <div class="p-node">03</div>
                        <h4>In-Mesh Transit</h4>
                        <p>Package flows through optimized transit gates. Real-time telemetry broadcasted over 5G.</p>
                    </div>
                    <div class="proc-item reveal-box">
                        <div class="p-node">04</div>
                        <h4>Final Mile Logic</h4>
                        <p>Automated terminal handover for the last phase of the journey. Consumer notified via secure
                            push.</p>
                    </div>
                    <div class="proc-item reveal-box">
                        <div class="p-node">05</div>
                        <h4>Ledger Settlement</h4>
                        <p>Delivery verified. Proof-of-arrival written to secondary ledger. Mission complete.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container-fluid">
                <div class="stat-row">
                    <div class="reveal-box">
                        <div class="st-v" data-v="10" data-s="K+">0</div>
                        <div class="st-l">Active Shipments</div>
                    </div>
                    <div class="reveal-box">
                        <div class="st-v" data-v="200" data-s="+">0</div>
                        <div class="st-l">Platform Partners</div>
                    </div>
                    <div class="reveal-box">
                        <div class="st-v" data-v="50" data-s="+">0</div>
                        <div class="st-l">Global Nodes</div>
                    </div>
                    <div class="reveal-box">
                        <div class="st-v" data-v="99" data-s=".9%">0</div>
                        <div class="st-l">Reliability Matrix</div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p style="text-align:center;color:var(--muted);font-size:.7rem;margin-top:80px">© <?= date('Y') ?>
                    ConsignX Intelligence. Unified Core v4.0</p>
            </div>
        </footer>
    </div>
