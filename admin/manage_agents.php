                    ...
                    <div class="modal-content neumorphic-card border-0">
                        ...
                        <form method="POST">
                            <div class="modal-body">
                                ...
                                <div class="alert alert-primary bg-primary bg-opacity-10 border-0 rounded-4 py-2 small d-flex align-items-center mb-0">
                                    <i class="bi bi-info-circle-fill me-2 fs-5"></i>
                                    <div>Credentials will be automatically generated and emailed instantly.</div>
                                </div>
                            </div>
                            <div class="modal-footer border-0">
                                <button type="button" class="btn neumorphic-btn" data-bs-dismiss="modal">Cancel</button>
