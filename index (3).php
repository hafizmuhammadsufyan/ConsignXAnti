...
<head>
   ...
   ═══════════════════════════════════════════════════════════════ */
    ...
    .mask-wrap {
        ...
        aspect-ratio: 16/7;
        position: relative;
        clip-path: inset(0 42% 0 42% round 22px);
   ...
   ═══════════════════════════════════════════════════════════════ */
    ...
    .gal-hover {
        position: absolute;
        inset: 0;
        background: linear-gradient(135deg, rgba(59, 124, 253, .35) 0%, rgba(99, 102, 241, .25) 100%);
        opacity: 0;
        transition: opacity .4s;
        display: flex;
        flex-direction: column;
...
<body>
    ...
    <nav id="nav">
        ...
        <div class="nr">
            <a href="#" class="btn-g">Sign In</a>
            <a href="#" class="btn-p">Get Started</a>
        </div>
    </nav>
    ...
    <div id="brand-scene">
        ...
        <div id="hero-bg">
            <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=1800&q=80" alt="" loading="eager">
            <div class="hb-ov"></div>
        </div>
    ...
    <div id="hs-scene">
        ...
        <div class="hs-msgs">
            ...
            <div class="hs-msg" id="hm3">
                ...
                <h2 class="hm-h">Built for <em>Scalable</em><br>Delivery Networks</h2>
    ...
    <section id="cta">
        ...
        <div class="container" style="position:relative;z-index:2">
            ...
            <p class="cta-s rev">Join thousands of logistics companies already using ConsignX to deliver faster, smarter
                and at lower cost.</p>
            <div class="cta-b rev">
                <a href="#" class="btn-cta">Start Free 14-Day Trial</a>
