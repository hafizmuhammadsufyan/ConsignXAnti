                ...
                <div class="neumorphic-card p-4 p-md-5 mb-5">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
                        ...
                        <div class="d-flex align-items-center gap-2">
                             <a href="all_shipments.php" class="btn btn-sm btn-outline-primary px-3 fw-bold me-2 rounded-3 border-2">
                        ...
                        <div class="table-responsive" id="shipmentsTableContainer">
                            ...
                            <tbody id="shipmentsTableBody">
                                <?php if (empty($shipments)): ?>
                                    <tr><td colspan="7" class="text-center text-muted py-5">No matching shipments found.</td></tr>
                                <?php else: ?>
